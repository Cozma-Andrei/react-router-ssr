...
import { headerCardsData } from '../../data/pageData';
...
export function HeaderSection() {
  ...
  const visibleCards = isMobile ? headerCardsData.slice(0, 2) : headerCardsData;
        ...
        <Container>
          ...
          <div className="header-section__actions">
            ...
            <div className="header-section__contributors">
              <img src="/assets/images/jetbrains-logo.svg" alt="JetBrains" />
          ...
          <div className="kto-grid kto-grid-gap-16 kto-offset-top-48">
            {visibleCards.map(card => (
              <a key={card.id} href={card.link} className={cn('rescui-card', 'kto-col-3 kto-col-md-6 kto-col-sm-12')}>
